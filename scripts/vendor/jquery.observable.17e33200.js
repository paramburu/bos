(function($) {
    ...
    fireEvent = function(data, event, params) {
    ...
    listenerAdder = function(event, listener) {
        if ( $.isArray( event ) ) {
            var rval = [];
    ...
    listenerRemover = function(event, listenerID) {
        var listeners = getEventListeners(this, event);
    ...
    createObservableObject = function(value) {
    ...
    observableArrayItems = function(arr) {
    ...
    createObservableArray = function(arr) {
